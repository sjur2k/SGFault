...
\\
The motivation for doing this, is to get a deeper understanding for low level programming and to become\\
more fluent in C. There is no end-goal for this project, but it is not intended to be offering anything\\
that doesn't already exist. It is merely a practice project.
